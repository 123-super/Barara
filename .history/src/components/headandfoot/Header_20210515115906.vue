    ...
    <div class="clearfix topbar">
      <div class="container">
        <div class="topbar-nav">
          <a href="" style="color: rgb(212, 40, 38)" @click="toHome"
            >欢迎来到巴拉啦官网</a
          ><span>|</span> <a href="javascript:;" @click="toMyOrder">我的订单</a
          ><span>|</span>
        ...
        <div class="topbar-info">
          <a href="" style="color: rgb(212, 40, 38)">{{ this.uState }}</a
  ...
  methods: {
    ...
    search() {
      search(this.searchName).then(res => {
        if (data.status == 200)
          this.$store.commit("searchResult",data.data) 
      })
    }
  },
}
