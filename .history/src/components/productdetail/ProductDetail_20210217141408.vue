<template>
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane label="产品详情" name="first">
            <template slot-scope="scope">
              <div class="detailpage" :index="scope.row.id">
                <div class="detailpage-fr">
                  <ul class="productitems">
                    <h3>产品参数</h3>
                    <li>
                      <span class="keyname">适用部位:</span
                      ><span class="keyvalue">脸部</span>
                    </li>
                    <li>
                      <span class="keyname">适用部位:</span
                      ><span class="keyvalue">脸部</span>
  ...
  <div class="commentpage">
    <div class="commentitems">
      ...
      <div class="clearfix">
        <span class="user">张三</span><span class="datetime">2010-10-10</span>
      </div>
    </div>
  </div>
