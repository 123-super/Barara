      ...
      <template>
        <el-tabs value="first" @tab-click="handleClick">
          <el-tab-pane label="所有订单" name="first">
            ...
            >
              <el-table-column fixed prop="date" label="宝贝" width="264">
              </el-table-column>
              <el-table-column prop="name" label="单价" width="240">
              </el-table-column>
              <el-table-column label="数量" width="240"> </el-table-column>
...
export default {
  ...
  computed: {
    ...mapState(['totalNumber', 'totalPrice']),
  },
  created() {
