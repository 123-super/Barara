...
export default {
  ...
  methods: {
    ...
    account() {
      ...
      let { status, createDate, orderNum, address, postNum, receiverName, tel } = {
        uid, status, createDate, orderNum, ...this.form
      }

      addOrder({ uid, status, createDate, orderNum, address, postNum, receiverName, tel }, { pid, oid, uid, number }).then(() => {
