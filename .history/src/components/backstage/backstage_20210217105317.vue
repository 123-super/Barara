  ...
  <div class="back">
    <el-tabs v-model="activeName" type="border-card">
      ...
      <el-dialog title="修改用户" :visible.sync="dialogFormVisible4">
        <el-form :model="tableData1[userformid]">
          <el-form-item label="用户名称" :label-width="formLabelWidth">
            <el-input
              v-model="tableData1[1].username"
              autocomplete="off"
            ></el-input>
          </el-form-item>
          <el-form-item label="用户密码" :label-width="formLabelWidth">
            <el-input
              v-model="tableData1[1].password"
              autocomplete="off"
            ></el-input>
          </el-form-item>
        </el-form>
        <div slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="updUById(tableData1[userformid])"
            >确 定</el-button
          >
        </div>
      </el-dialog>
...
export default {
  ...
  methods: {
    ...
    fillupdate(id) {
      ...
      this.userformid = id
      this.form4 = this.tableData1.forEach()
