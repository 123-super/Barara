      ...
      <el-tab-pane label="用户管理" name="first">
        <div class="container">
          <el-form :inline="true">
            ...
            <el-button @click="toAdd" type="success">添加</el-button>
          </el-form>
      ...
      <el-tab-pane label="分类管理" name="third">
        <div class="container">
          ...
          <el-table :data="tableData" height="250" border style="width: 40%">
            ...
            <el-table-column prop="atribute" label="属性管理" width="180">
              <template slot-scope="scope"><i></i></template>
            </el-table-column>
            <el-table-column prop="atribute" label="产品管理" width="180">
            </el-table-column>
            <el-table-column label="操作">
              <template slot-scope="scope">
                <el-button
